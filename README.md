...
- **[docs/MULESOFT_CATALOG_INGEST.md](docs/MULESOFT_CATALOG_INGEST.md)** — large-catalog ingest; **guided wizard** (`write-demo-csv.ps1 -Interactive` / `write-demo-csv.sh --interactive`) plus manual **step-by-step** `sf data import bulk` (parent then `Pricing_Item__c`; **`sf__Id`** not Job Id `750...`)  
