...
| [MULESOFT_CATALOG_INGEST.md](./MULESOFT_CATALOG_INGEST.md) | Large-catalog ingest (MuleSoft / Bulk API 2.0); **SF CLI step-by-step** (parent then child, CRLF, `sf__Id`) vs in-app upload |
